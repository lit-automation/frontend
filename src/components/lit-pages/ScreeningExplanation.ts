...
export class ScreeningExplanation extends LitElement {
    ...
    <div>
        ...
        <div class="row">
        <p>
        Before starting to screening at the <a href="/screen-abstract">abstract screening page</a> you'll need to initialize the model
        ...
        When the model is initialized, it is recommended to screen 30% of your article set using
